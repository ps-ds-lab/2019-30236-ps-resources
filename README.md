...
- [Spring database backed security](https://www.baeldung.com/spring-security-authentication-with-a-database) - mention: the tutorials on this site usually include an xml configuration section, however this part should be ignored when using annotation configuration
